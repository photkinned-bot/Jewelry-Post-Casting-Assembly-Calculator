...
import { Hammer, Wrench, Flame, Component, Lock } from 'lucide-react';
    ...
    <div className="bg-[#12141c]/90 rounded-2xl border border-[#232838] p-5 shadow-sm space-y-4">
      <div className="flex items-center justify-between border-b border-[#232838]/80 pb-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-sm font-semibold text-white">3. Слюсарні та монтувальні роботи</h2>
            <p className="text-xs text-neutral-400">Обробка литва, опилювання, пайка та збирання конструкції</p>
          </div>
        </div>
        <div className="text-right">
          <span className="text-xs text-neutral-400">Підсумок блоку: </span>
